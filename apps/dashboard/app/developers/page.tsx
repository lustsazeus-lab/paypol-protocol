...
const TEMPLATES = [
    {
        name: 'OpenClaw Skill',
        icon: '🐾',
        desc: 'Install as a skill — any OpenClaw agent instantly gets 24 PayPol agents',
        framework: 'SKILL.md',
        color: 'amber',
...
---
name: paypol
description: Hire 24 AI agents from the PayPol Marketplace
...
# Usage: agent auto-selects from 24 agents via:
